...
//Antecedentes
router.get(
  "/expediente/antecedentes_index/:id",
  isLoggedIn,
  ExpedienteController.indexAntecedente
);

// Expediente
router.get(
  "/expediente_seleccion/:id",
  isLoggedIn,
  ExpedienteController.indexSeleccion
);
...
router.get(
  "/expediente_paciente",
  isLoggedIn,
  ExpedienteController.indexPaciente
);

router.get(
  "/expediente/expediente_confirmar/:id",
  ExpedienteController.indexConfirmar
);
router.get(
  "/expediente/expediente_visualizar/:id",
  ExpedienteController.indexVisualizar
);
router.post(
  "/expediente/expediente_confirmar/:id",
  ExpedienteController.saveConfirmar
);

router.get(
  "/expediente/expediente_consulta/:id",
  ExpedienteController.indexConsulta
);
router.post(
  "/expediente/expediente_consulta/:id",
  ExpedienteController.saveConsulta
);
// router.get('/expediente/expediente_consulta_resume', ExpedienteController.indexConsulta);
router.get(
  "/expediente/expediente_consulta_resume",
  ExpedienteController.indexallConsulta
);
...
router.get(
  "/expediente/expediente_antecedentes/:id",
  ExpedienteController.createAntecedente
);
router.post(
  "/expediente/expediente_antecedentes/:id",
  ExpedienteController.storeAntecedente
);
