...
router.get("/consulta/consulta_pdf", ConsultaController.exportpdf);
...
router.get(
  "/consulta/diagnostico_create/:id",
  ConsultaController.createDiagnostico
);
router.post(
  "/consulta/diagnostico_create/:id",
  ConsultaController.storeDiagnostico
);
